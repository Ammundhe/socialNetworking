    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pageImage', models.ImageField(blank=True, null=True, upload_to='mypage/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Pageimges', models.ImageField(blank=True, null=True, upload_to='media/')),
                ('Page_videos', models.FileField(blank=True, null=True, upload_to='media/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='page', to='page.page')),
            ],
        ),
    ]
